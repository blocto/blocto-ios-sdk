...
indirect enum BTABIType: Equatable, CustomStringConvertible, Hashable {
    ...
    case dynamicArray(BTABIType)

    /// Tuple consisting of elements of the given types
    case tuple([BTABIType])
