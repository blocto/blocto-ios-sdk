...
final class BTABIEncoder {
    ...
    /// Encodes an `ABIValue`
    public func encode(_ value: BTABIValue) throws {
        switch value {
    ...
    /// Encodes a tuple
    public func encode(tuple: [BTABIValue]) throws {
        var headSize = 0
    ...
    public func encode(function: BTFunction, arguments: [Any]) throws {
    ...
    public func encode(_ value: Bool) throws {
        data.append(Data(repeating: 0, count: BTABIEncoder.encodedIntSize - 1))
    ...
    public func encode(_ value: BigUInt) throws {
        ...
        if valueData.count > BTABIEncoder.encodedIntSize {
            throw BTABIError.integerOverflow
        }

        data.append(Data(repeating: 0, count: BTABIEncoder.encodedIntSize - valueData.count))
    ...
    public func encode(_ value: BigInt) throws {
        guard let serialized = value.serialize(bitWidth: BTABIEncoder.encodedIntSize) else {
            throw BTABIError.integerOverflow
        }
    ...
    /// Encodes an address
    public func encode(_ address: AnyAddress) throws {
    ...
    public func encode(signature: String) throws {
        data.append(try BTABIEncoder.encode(signature: signature))
    }
    ...
    public static func encode(signature: String) throws -> Data {
        ...
        let hash = Hash.keccak256(data: bytes)
        return hash[0..<4]
    }
}
