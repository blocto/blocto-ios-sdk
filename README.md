...
pod 'BloctoSDK/Solana', '~> 0.3.5'

# or

pod 'BloctoSDK/EVMBase', '~> 0.3.5'

# or

pod 'BloctoSDK/Flow', '~> 0.3.5'
```
...
```swift
.package(url: "https://github.com/portto/blocto-ios-sdk.git", .upToNextMinor(from: "0.3.5"))
```
