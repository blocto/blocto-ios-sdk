...
pod 'BloctoSDK/Solana', '~> 0.6.3'

# or

pod 'BloctoSDK/EVMBase', '~> 0.6.3'

# or

pod 'BloctoSDK/Flow', '~> 0.6.3'
```
...
```swift
.package(url: "https://github.com/portto/blocto-ios-sdk.git", .upToNextMinor(from: "0.6.3"))
```
