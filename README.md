...
pod 'BloctoSDK/Solana', '~> 0.4.1'

# or

pod 'BloctoSDK/EVMBase', '~> 0.4.1'

# or

pod 'BloctoSDK/Flow', '~> 0.4.1'
```
...
```swift
.package(url: "https://github.com/portto/blocto-ios-sdk.git", .upToNextMinor(from: "0.4.1"))
```
